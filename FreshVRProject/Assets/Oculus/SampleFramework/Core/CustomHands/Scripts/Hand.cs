...
namespace OVRTouchSample
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        {
            m_isPointing = !OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, m_controller);
            //m_isGivingThumbsUp = !OVRInput.Get(OVRInput.NearTouch.PrimaryThumbButtons, m_controller);
            m_isGivingThumbsUp = !OVRInput.GetUp(OVRInput.Button.PrimaryIndexTrigger, m_controller);
        }
